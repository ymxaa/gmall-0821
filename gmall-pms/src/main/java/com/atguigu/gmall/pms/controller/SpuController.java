...
public class SpuController {
    ...
    @ApiOperation("后台管理分页查询分类商品")
    public ResponseVo<PageResultVo> querySpuByPage(PageParamVo paramVo,@PathVariable("categoryId") Long cid){
        PageResultVo pageResultVo = spuService.querySpuByCidAndPage(paramVo,cid);
